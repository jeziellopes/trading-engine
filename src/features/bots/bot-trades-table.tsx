...
if (trades.length === 0) {
return <div className="px-4 py-8 text-center text-xs text-muted-foreground">No trades recorded</div>;
}
...
<TableHead key={col} className="text-[10px] font-normal uppercase tracking-wide">{col}</TableHead>
))}
</tr>
</TableHeader>
<TableBody>
...
<TableCell>
<span className={cn("font-mono font-semibold uppercase text-[10px]",
...
<TableCell>
<span className={cn("font-mono", trade.pnl >= 0 ? "text-trading-profit" : "text-trading-loss")}>
