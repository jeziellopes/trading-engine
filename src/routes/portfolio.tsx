		...
		<ErrorBoundary>
			<div className="w-full max-w-5xl mx-auto px-6 py-8 space-y-8">
				...
				<div className="flex items-center justify-between">
					...
					<Link
						to={"/symbol/$symbol" as never} params={{ symbol: "BTCUSDT" } as never}
				...
				<div className="space-y-3">
					<h2 className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Trade History</h2>
