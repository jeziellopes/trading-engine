...
// biome-ignore lint/suspicious/noExplicitAny: route path not yet in generated tree
export const Route = createFileRoute("/design-system" as any)({
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Component gallery for the trading engine. All tokens sourced from design-system.json.
          </p>
        </div>
        ...
        <Section title="Order Book">
          <div className="max-w-xs bg-ds-gray-100 rounded-md border border-border overflow-hidden">
            ...
            <SpreadBar
              bestBid={MOCK_BIDS[0]!.price}
              bestAsk={MOCK_ASKS[0]!.price}
              lastPrice={67843.5}
              spreadAmount={2.5}
          ...
          <div className="max-w-xs bg-ds-gray-100 rounded-md border border-border p-4 space-y-3">
            ...
            <div className="space-y-2">
              <div className="space-y-1">
                <label className="text-[10px] font-mono text-muted-foreground">Price (USDT)</label>
                <Input placeholder="67,843.50" type="number" className="h-8 text-sm" />
              </div>
              <div className="space-y-1">
                <label className="text-[10px] font-mono text-muted-foreground">Amount (BTC)</label>
        ...
        <div className="border-t border-border pt-6 text-[10px] font-mono text-muted-foreground">
          <p>CypherUI Trading · design-system.json v2.0.0</p>
          <p className="mt-1">
            Regenerate tokens:{" "}
            <code className="bg-ds-gray-800 px-1.5 py-0.5 rounded">
