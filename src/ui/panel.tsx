...
return (
<div className={cn("bg-card rounded-md border border-border flex flex-col h-full overflow-hidden", className)}>
...
<div className={cn("flex-1 min-h-0", noScroll ? "flex flex-col overflow-hidden" : "overflow-y-auto")}>
{children}
</div>
</div>
);
